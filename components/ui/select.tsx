...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-2 pl-8 pr-2 text-sm outline-none focus:bg-blue-50 focus:text-blue-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-gray-50 data-[highlighted]:bg-blue-50 data-[highlighted]:text-blue-900 dark:focus:bg-blue-900/20 dark:focus:text-blue-100 dark:hover:bg-gray-700 dark:data-[highlighted]:bg-blue-900/20 dark:data-[highlighted]:text-blue-100",
      className
    )}
    {...props}
  >
